...
import 'package:wawancara_ai/api/api_exceptions.dart';
import 'package:wawancara_ai/utils/constants.dart' as AppConst;
...
class ApiProvider {
  ...
  // ApiProvider({this.loginSuccess, this.otp});
  ...
  Future<dynamic> postMultipart(String url, {required List<File> files}) async {
    var responseJson;
    try {
